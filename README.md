...
[Introduction]
Ukraine Humanitarian/Refugee Crisis has become a world-class news recently. In this project, we did sentiment analysis about 900 Tweets from Twitter about people's view about Ukrainian Crisis. And we also create a classifier using 90% of the Tweets, then test it on 90 Tweets and get the Confusion Matrix.
